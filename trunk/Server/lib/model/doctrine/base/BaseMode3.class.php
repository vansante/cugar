 ...
 * @method enum                getTrafficMode()          Returns the current record's "traffic_mode" value
 ...
 * @method Mode3               setTrafficMode()          Sets the current record's "traffic_mode" value
...
abstract class BaseMode3 extends RadiusSsid
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('traffic_mode', 'enum', null, array(
             'type' => 'enum',
             'values' => 
             array(
              0 => 'no_tunneling',
              1 => 'tunnel_to_data_tunnel',
              2 => 'tunnel_to_auth_tunnel',
             ),
