...
/**
 * DhcpServer form base class.
 *
 * @method DhcpServer getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseDhcpServerForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dhcp_server[%s]');
