...
abstract class BaseMode3Form extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'radius_acct_ip'               => new sfWidgetFormInputText(),
      'radius_acct_port'             => new sfWidgetFormInputText(),
      'radius_acct_shared_secret'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'radius_acct_ip'               => new sfValidatorString(array('max_length' => 15)),
      'radius_acct_port'             => new sfValidatorInteger(),
      'radius_acct_shared_secret'    => new sfValidatorString(array('max_length' => 255, 'min_length' => 1)),
