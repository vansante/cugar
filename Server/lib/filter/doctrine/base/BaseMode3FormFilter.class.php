...
abstract class BaseMode3FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'radius_acct_auth_ip'            => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'radius_acct_auth_port'          => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'radius_acct_auth_shared_secret' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'radius_acct_auth_ip'            => new sfValidatorPass(array('required' => false)),
      'radius_acct_auth_port'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'radius_acct_auth_shared_secret' => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'radius_acct_auth_ip'            => 'Text',
      'radius_acct_auth_port'          => 'Number',
      'radius_acct_auth_shared_secret' => 'Text',
